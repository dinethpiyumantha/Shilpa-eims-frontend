            ...
            <div class="card-body">
                ...
                <h4>Student Information</h4>
                    <div class="row g-3 align-items-center d-flex flex-row-reverse">
                            <div class="col-auto">
                                <input type="text" id="inputPassword6" class="form-control" aria-describedby="passwordHelpInline" placeholder="STU0001">
                            </div>
                            <div class="col-auto">
                                <label for="inputPassword6" class="col-form-label">Student ID</label>
                            </div>   
                    </div>
